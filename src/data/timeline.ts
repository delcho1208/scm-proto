...
export const timelineData: Record<TimelineKey, TimelinePoint> = {
  "25Q3": point(
    { label: "2025 Q3", tick: "25 Q3", isPrediction: false, totalInventory: 15200, utilization: 86.4, stockoutRisk: 6.2, roi: 7.8 },
  ...
  "25Q4": point(
    { label: "2025 Q4", tick: "25 Q4", isPrediction: false, totalInventory: 17180, utilization: 89.1, stockoutRisk: 7.1, roi: 9.2 },
  ...
  PRES: point(
    { label: "현재 (2026.03)", tick: "26.03", isPrediction: false, totalInventory: 20037, utilization: 93.6, stockoutRisk: 8.4, roi: 12.4 },
  ...
  "26Q2": point(
    { label: "2026 Q2", tick: "26 Q2", isPrediction: true, totalInventory: 18760, utilization: 95.2, stockoutRisk: 10.8, roi: 11.6 },
  ...
  "26Q3": point(
    { label: "2026 Q3", tick: "26 Q3", isPrediction: true, totalInventory: 16940, utilization: 97.1, stockoutRisk: 13.5, roi: 10.3 },
  ...
  "27Q1": point(
    { label: "2027 Q1", tick: "27 Q1", isPrediction: true, totalInventory: 14580, utilization: 98.4, stockoutRisk: 17.9, roi: 7.4 },
