...
export const regions: Record<string, Region> = {
  ...
  Seoul: {
    ...
    box: { top: "13%", left: "26%", width: "20%", height: "6%" }, z: 40,
  },
  Gyeonggi: {
    id: "Gyeonggi",
    name: "수도권",
    ...
    box: { top: "11%", left: "18%", width: "42%", height: "13%" }, z: 20,
  },
  Gangwon: {
    id: "Gangwon",
    name: "강원",
    ...
    box: { top: "7%", left: "58%", width: "38%", height: "15%" }, z: 20,
  },
  Chungcheong: {
    id: "Chungcheong",
    name: "충청",
    ...
    box: { top: "26%", left: "14%", width: "46%", height: "13%" }, z: 20,
  },
  Daegu: {
    id: "Daegu",
    name: "대구/경북",
    ...
    box: { top: "24%", left: "58%", width: "38%", height: "20%" }, z: 20,
  },
  Honam: {
    id: "Honam",
    name: "호남",
    ...
    box: { top: "42%", left: "8%", width: "44%", height: "20%" }, z: 20,
  },
  Busan: {
    id: "Busan",
    name: "부산/울산/경남권",
  ...
  Jeju: {
    ...
    box: { top: "87%", left: "6%", width: "32%", height: "8%" }, z: 20,
  },
};
